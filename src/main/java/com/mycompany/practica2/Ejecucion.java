...
public class Ejecucion extends javax.swing.JFrame {
     ...
     */
   Datos[] datos = {
                new Datos("Progra",100),
                new Datos("arte",20)
   
   };
    
    
    private Animaciones animador;
    ...
    public Ejecucion() {
        ...
        cronometro.start();
        animador = new Animaciones(datos,jPanel3);
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Caracteristicas del Ordenamiento");
